...
const DataComparisonPanel: React.FC<DataComparisonPanelProps> = ({
  ...
  return (
    <Card className={`p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 border-2 border-blue-200 dark:border-blue-800 shadow-lg h-full flex flex-col ${className}`}>
