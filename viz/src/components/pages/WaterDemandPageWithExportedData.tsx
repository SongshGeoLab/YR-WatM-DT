...
// Data structure matching Page5.ipynb exports
...
const WaterDemandPageWithExportedData: React.FC = () => {
  ...
  // Load exported data from Page5.ipynb
  const loadExportedData = useCallback(async () => {
    try {
      setLoading(true);
      setError(null);
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      {error && (
        <div className="bg-yellow-50 border border-yellow-200 text-yellow-700 px-4 py-3 rounded mb-6 dark:bg-yellow-900/20 dark:border-yellow-800 dark:text-yellow-300">
          <strong>Note:</strong> {error} (Using demo data)
        </div>
      )}
        ...
        <Card className="p-6 mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <p className="font-medium">Scenarios: {pageData?.time_series.n_scenarios || 'N/A'}</p>
            </div>
            <div>
...
export default WaterDemandPageWithExportedData;
